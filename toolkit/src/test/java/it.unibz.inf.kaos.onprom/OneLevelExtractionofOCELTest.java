...
////            OWLOntology onpromOntology = OWLManager.createOWLOntologyManager().loadOntologyFromOntologyDocument(OneLevelExtractionofOCELTest.class.getResourceAsStream("/ocel-ontology.owl"));
//            // start extraction process
//            if (output.createNewFile()) {
//                IOUtility.readJSON(queriesFile, AnnotationQueries.class).ifPresent(firstLevel -> {
//                    try {
//                        //generate final mapping
//                        SQLPPMapping firstMapping = new OCELOBDAMapper(domainOntology, SimpleOCELLogExtractor.getDefaultEventOntology(), obdaModel, dataSourceProperties, firstLevel).getOBDAModel();
//

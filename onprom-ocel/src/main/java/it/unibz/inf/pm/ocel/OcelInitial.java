...
public class OcelInitial {
    ...
    public static Map import_log(String log_path) throws DocumentException {
        return Importer.apply(log_path);
    }

    public static void export_log(Map log, String log_path) throws DocumentException {
        Exporter.apply(log, log_path);
    }

    public static boolean validate(String log_path, String schema_path) throws DocumentException {

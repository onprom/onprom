 ...
 */
public class CaseAnnotationQuery extends AnnotationQuery {

  public CaseAnnotationQuery() {
  }

  public CaseAnnotationQuery(String _name, String traceAnsVariable, String nameAnsVariable) {
    super(_name, traceAnsVariable, nameAnsVariable);
  }

  public CaseAnnotationQuery(String _name, String _firstAnsVariable, String _secondAnsVariable, List<AnnotationQuery> queries) {

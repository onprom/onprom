 ...
 */
public class ResourceAnnotationQuery extends AnnotationQuery {

  public ResourceAnnotationQuery() {
    //
  }

  public ResourceAnnotationQuery(String _name, String resourceAnnotationName, String valueAnsName) {
    super(_name, resourceAnnotationName, valueAnsName);
  }

  public ResourceAnnotationQuery(String _name, String _firstAnsVariable, String _secondAnsVariable, List<AnnotationQuery> queries) {

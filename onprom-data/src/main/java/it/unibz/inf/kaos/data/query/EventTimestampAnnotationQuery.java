 ...
 */
public class EventTimestampAnnotationQuery extends AnnotationQuery {

  public EventTimestampAnnotationQuery() {
    //
  }

  public EventTimestampAnnotationQuery(String query, String eventAnsVariable, String timestampAnsVariable) {
    super(query);

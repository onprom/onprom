 ...
 *
 */
public class ExecutionLogger implements ExecutionMsgListener {

	private StringBuilder execNote = new StringBuilder("");
	
	@Override
	public void addNewExecutionMsg(ExecutionMsgEvent log){
		
		this.execNote.append(log.getLog());
	}
	
	public String getExecNote(){
		
		return execNote.toString();
	}
}

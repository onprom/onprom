...
/**
 * This class provides some constants declaration related to the Event Ontology that is made for OnProm Project
 * @author Ario Santoso (santoso.ario@gmail.com / santoso@inf.unibz.it)
 *
 */
public class XESOntologyOnProm implements XESOntology{

	//Event Ontology location
		private static final String eventOntoPath = "/_EVENTONTO/eo-onprom.owl";
	...
	//OnProm event ontology vocabularies
		...
		private static final String LOG_CONCEPT = "";

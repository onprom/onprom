...
public class LogExtractorUsageExample1 {
	...
	private static String obdaFile = "postgres/conference10.obda";
	...
	//------- Annotation Queries----------
	private static AnnotationQueriesV2 annotation = importAnnotationQueries(inputPath + "conference.aqr"); 

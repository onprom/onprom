 ...
 * for constructing XES Event Log
 * 
 * Features:
 *    <ul>
 *    	<li>
 ...
 *    	</li>
 *    	<li>
 *  		In this version, the URI for a XES attribute contains the information about its key, type and value.
 *    		Moreover, this EBDAModel does not create the mappings that populate the attributes key/type/values. 
 *    		It assumes that the one that used this EBDAModel extracts such information from the Attribute URI. The 
 *    		form of an attribute URIs is as follows:
 *    
 *    		<pre>
 *    		{@code
 *    		[ANY_PREFIX_STRINGS] [SPECIAL_URI_DELIMETER] [ATT_TYPE] [SPECIAL_URI_DELIMETER] [ATT_KEY] [SPECIAL_URI_DELIMETER] [ATT_VALUE]  
 *    		}
 *    		</pre>
 *    
 * 		   for example:
 ...
 *    		<pre>
 *    		{@code
 *    		<http://www.example.org/elementaryAtt#@$&+$#+@literal#@$&+$#+@concept:name#@$&+$#+@Paper#@$&+$#+@>
 *    		}
 *    		</pre>
 *    
 * 		   where in this case:
 *    		<ul>
 *    			<li>
 *    				[ANY_PREFIX_STRINGS] = http://www.example.org/elementaryAtt
 *    			</li>
 *    			<li>
 * 		   			[SPECIAL_URI_DELIMETER] = #@$&+$#+@
 *    			</li>
 *    			<li>
 *    				[ATT_TYPE] = literal
 *    			</li>
 *    			<li>
 *    				[ATT_KEY] = concept:name
 *    			</li>
 *    			<li>
 *    				[ATT_VALUE] = Paper 
 *    			</li>
 ...
 *
 */
public class EBDAModelWithOptimizedXAttributesEncodingImpl extends EBDAModelAbstractImpl implements EBDAModelWithOptimizedXAttributesEncoding {
...
//	private static final Logger logger = Logger.getLogger(LEConstants.LOGGER_NAME);
	...
	//URI template for Event Ontology Objects
		...
		//Generic URI Template for Elementary Attribute, it needs 3 arguments
		//(1st: URI template/place holder)
		private final String elementaryAttURITemplate = String.format(this.uriTemplate,
				XESEOConstants.eventOntoPrefix+"elementaryAtt"+
						LEConstants.SPECIAL_URI_DELIMETER+"%s"+		//type
						LEConstants.SPECIAL_URI_DELIMETER+"%s"+		//key
						LEConstants.SPECIAL_URI_DELIMETER+"%s"+
						LEConstants.SPECIAL_URI_DELIMETER); 	//value
...
//		private final String xesAttKeyOrgResource = "\"org:resource\"^^xsd:string"; //based on XES Organization extension
		...
		private final String xesAttTypeLiteral = "literal";
		private final String xesAttTypeTimestamp = "timestamp";
		
//		private final String xesAttKeyConceptName = "concept:name"; //based on XES Concept extension
//		private final String xesAttKeyTimeTimestamp = "time:timestamp"; //based on XES Time extension
//		private final String xesAttKeyLifecycleTransition = "lifecycle:transition"; //based on XES Lifecycle extension
//		private final String xesAttKeyOrgResource = "org:resource"; //based on XES Organization extension

		private final String xesAttKeyConceptName = LEConstants.XES_ATT_KEY_CONCEPT_NAME_SPECIAL_REP; //based on XES Concept extension
		private final String xesAttKeyTimeTimestamp = LEConstants.XES_ATT_KEY_TIME_TIMESTAMP_SPECIAL_REP; //based on XES Time extension
		private final String xesAttKeyLifecycleTransition = LEConstants.XES_ATT_KEY_LIFECYCLE_TRANSITION_SPECIAL_REP; //based on XES Lifecycle extension
		private final String xesAttKeyOrgResource = LEConstants.XES_ATT_KEY_ORG_RESOURCE_SPECIAL_REP; //based on XES Organization extension
	 ...
	 */
	EBDAModelWithOptimizedXAttributesEncodingImpl(){
		super();

		//add Event Ontology Prefix
		//super.addEventOntologyPrefix();
...
//			);
		...
		String targetQuery1 = 
				String.format(this.traceAttTargetQueryTemplate, 
					String.format(this.traceURITemplate, traceVariable),
					String.format(this.elementaryAttURITemplate, 

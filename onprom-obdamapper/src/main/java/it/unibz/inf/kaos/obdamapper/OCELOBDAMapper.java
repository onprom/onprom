...
public class OCELOBDAMapper {
    private static final String projectUri = " <http://onprom.inf.unibz.it/ocel/";
    protected static final Logger logger = (Logger) LoggerFactory.getLogger(OCELOBDAMapper.class);
    private static final String objPropTripleTemplate = " <http://onprom.inf.unibz.it/ocel/%s> %s <http://onprom.inf.unibz.it/ocel/%s> . "; //<[Object]> [ObjectProperty] <[Object]>
    private static final String dataPropTripleTemplate = " <http://onprom.inf.unibz.it/ocel/%s> %s %s . "; //<[Object> [DataProperty] <[Value]>
    private static final String conceptTripleTemplate = " <http://onprom.inf.unibz.it/ocel/%s> a %s . "; //<[Object]> rdf:type <[Class]>
//    private static final String objPropTripleTemplate = projectUri + "%s> %s "+ projectUri + "%s> . "; //<[Object]> [ObjectProperty] <[Object]>
//    private static final String dataPropTripleTemplate = projectUri + "%s> %s %s . "; //<[Object> [DataProperty] <[Value]>
//    private static final String conceptTripleTemplate = projectUri + "%s> a %s . "; //<[Object]> rdf:type <[Class]>

...
public class Ocelxml {
    ...
    public static String getType(String type)
    {
        ...
        if(typeLower.indexOf("float") != -1 || typeLower.indexOf("double") != -1)
        {
            return "Float";
        }else if(typeLower.indexOf("object") != -1)
        {
            return "String";
        }else {
            return "String";
    ...
    public static void apply(Map<String,Object> log, String output_path, String ... parameters) throws DocumentException
    {
        ...
        for(String key : log.keySet())
        {
            if((prefix+"global-event").equals(key))
            {
                ...
                Iterator<String> iter = global_eventMap.keySet().iterator();
                while(iter.hasNext()) {
            ...
            if((prefix + "global-object").equals(key))
            {
                ...
                Iterator<String> iter = global_objectMap.keySet().iterator();
                while(iter.hasNext()) {
                    String stringkey = iter.next();
            ...
            if((prefix + "global-log").equals(key))
            {
                ...
                Iterator<String> iter = global_logMap.keySet().iterator();
                while(iter.hasNext()) {
                    String stringkey = iter.next();
            ...
            if((prefix + "events").equals(key))
            {
                ...
                Iterator<String> iter = eventsMap.keySet().iterator();
                while(iter.hasNext()) {
                    //create <event> node
                    ...
                    String eventkey = iter.next(); //e1,e2,e3
                    eventId.addAttribute("key","id");
                    eventId.addAttribute("value",eventkey);
                    Map<String,Object> eventMap = (Map<String, Object>) eventsMap.get(eventkey);
                    Iterator<String> eventIter = eventMap.keySet().iterator();
                    while(eventIter.hasNext()){
                        String stringkey = eventIter.next();
            ...
            if((prefix + "objects").equals(key))
            {
                ...
                Iterator<String> iter = objectsMap.keySet().iterator();
                while(iter.hasNext()) {
                    //create <event> node
                    ...
                    eventId.addAttribute("key","id");
                    eventId.addAttribute("value",eventkey);
                    Map<String,Object> eventMap = (Map<String, Object>) objectsMap.get(eventkey);
                    Iterator<String> eventIter = eventMap.keySet().iterator();
                    while(eventIter.hasNext()){
                        String stringkey = eventIter.next();

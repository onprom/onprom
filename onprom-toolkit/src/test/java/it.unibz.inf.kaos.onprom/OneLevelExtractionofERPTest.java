...
//            OWLOntology onpromOntology = OWLManager.createOWLOntologyManager().loadOntologyFromOntologyDocument(OneLevelExtractionofERPTest.class.getResourceAsStream("/eo-onprom.owl"));
